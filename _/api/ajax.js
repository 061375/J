...
export class Base {
    constructor(_url, options = {}) {
        ...
        if (options.hasOwnProperty("contentType")) {
            this.contentType = options === null || options === void 0 ? void 0 : options.contentType;
        }
    ...
    get(method, data = {}, callback = () => { }) {
        ...
        if (this.dataType == "json") {
            this.getData(this._url + method, {
                ...
                this.dataloading = false;
                this.throttle = false;
                if ((response === null || response === void 0 ? void 0 : response.update) == 1)
                    J.$('#updatemessage').addClass('show');
                if ((response === null || response === void 0 ? void 0 : response.update) == 2) {
                    console.log("update !!!!!");
                    window.location.reload();
                }
                if ((response === null || response === void 0 ? void 0 : response.update) == 3) {
                ...
                //
                if (undefined !== (response === null || response === void 0 ? void 0 : response.redirect) && (response === null || response === void 0 ? void 0 : response.redirect) != '' && null != (response === null || response === void 0 ? void 0 : response.redirect)) {
                    window.location = response === null || response === void 0 ? void 0 : response.redirect;
                    return;
                }
                //console.log(response)
                if ((response === null || response === void 0 ? void 0 : response.success) == 1) {
                    if (typeof callback === 'function') {
                        if (response.allowstring)
                            callback(response === null || response === void 0 ? void 0 : response.message);
                        else
                            callback(JSON.parse(response === null || response === void 0 ? void 0 : response.message));
                    }
                    return;
                }
                if ((response === null || response === void 0 ? void 0 : response.softerror) === undefined) {
                    Public.ISERRORING = true;
                    return;
                }
                ...
                if ((response === null || response === void 0 ? void 0 : response.errors) !== undefined && (response === null || response === void 0 ? void 0 : response.errors) !== null) {
                    var errors = "";
                    ...
                    if (!Constants.SUPPRESSALERTERROR)
                        J.Debug.ErrorHandler("An Ajax error occured [2] ", response === null || response === void 0 ? void 0 : response.message);
                    Public.ISERRORING = true;
                }
            })
                .catch(error => {
            ...
            xhr.onreadystatechange = () => {
                if (xhr.readyState === XMLHttpRequest.DONE) {
                    if (xhr.status === 200) {
                        ...
                        resolve(JSON.parse(response === null || response === void 0 ? void 0 : response.d));
                    }
                    else {
